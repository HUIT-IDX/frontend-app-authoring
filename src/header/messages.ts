...
const messages = defineMessages({
  ...
  'header.links.libraries': {
    ...
    defaultMessage: 'Cập nhật thư viện',
  ...
  'header.links.proctoredExamSettings': {
    ...
    defaultMessage: 'Thiết lập bài thi có giám thị',
  ...
  'header.links.exportLibrary': {
    ...
    defaultMessage: 'Sao lưu vào kho lưu trữ cục bộ',
  ...
  'header.label.courseOutline': {
    ...
    defaultMessage: 'Quay lại khung chương trình khóa học trong Studio',
